...
In this tutorial we explore how SIIs contribute to wind farm planning. Learning outcome are to understand
...
The further structure of this learning material is as follows: 
      2. Introduction to SIIs and wind farm planning
     We give you some background information on SIIs and on wind farm planning in Germany and present the case of repowering and expanding a wind farm in Lorup, a small community in the district of Emsland in Lower Saxony.
     3. The case of extending a wind farm in Lorup, Germany
We demonstrate how to search for the data needed for wind farm planning in Lorup, how to access and integrate the data into the dataset for the project, and how to analyze the data using QGIS to identify the potential extension area for the wind farm.
...
We summarize the workflow of windfarm planning and discuss both the benefits and the issues we faced regarding the underlying Spatial Data Infrastructures. We present some questions that you can use to check if you have achieved the key learning objectives.
...
You are free to use, alter and reproduce the tutorial (H5P content, textual documents, graphics) under the terms of the CC-BY-SA 4.0 license. Any code provided with the tutorial can be used under the terms of the MIT license. Please see the full license terms [link to license file in the Github Repository].)
